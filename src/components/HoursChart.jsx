...
const HoursChart = ({ totalHours, goalHours, setIsUpdateHoursModalOpen }) => {
  ...
  // Convertir las horas decimales a HH:MM
  ...
  return (
    <div className="relative pt-4 rounded-lg flex flex-col max-w-96">
      <div className="flex items-center justify-center relative">
        <div
          onClick={setIsUpdateHoursModalOpen}
          className="absolute inset-0 flex flex-col items-center justify-center cursor-pointer rounded-full m-10"
        >
          <p className="text-4xl font-bold text-gray-600">{formatTime(totalHours)} hs</p>
